...
TARGET_PREBUILT_KERNEL := device/micromax/doodle/kernel
TARGET_KERNEL_SOURCE := device/micromax/kernel
TARGET_KERNEL_CONFIG := cm_delos_chnopen_user_defconfig
...
TARGET_SPECIFIC_HEADER_PATH := device/micromax/doodle/include
#TARGET_SPECIFIC_HEADER_PATH := device/micromax/kernel/include
...
COMMON_GLOBAL_CFLAGS += -DBINDER_COMPAT -DNEEDS_VECTORIMPL_SYMBOLS -Dmicromax_CAMERA_LEGACY
...
BOARD_EGL_CFG := device/micromax/doodle/prebuilt/system/lib/egl/egl.cfg
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/micromax/doodle/bluetooth
...
## micromax has weird framebuffer
...
## Recovery
TARGET_RECOVERY_FSTAB := device/micromax/doodle/ramdisk/fstab.qcom
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 1509949440
